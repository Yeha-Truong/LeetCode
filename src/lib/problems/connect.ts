...
// export default function connect(root: ConnectNode | null): ConnectNode | null {
//     if (root == null)
//         return null;
...
// export default function next(root: ConnectNode | null, current: ConnectNode): ConnectNode | null {
